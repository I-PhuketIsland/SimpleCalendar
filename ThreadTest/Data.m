...
+ (NSMutableArray *)yearMonthDay:(NSDate *)date {
    ...
    [arr addObjectsFromArray:@[[NSString stringWithFormat:@"%ld",[self year:date]],[NSString stringWithFormat:@"%ld",[self month:date]],[NSString stringWithFormat:@"%ld",[self day:date]]]];
    return  arr;
}
